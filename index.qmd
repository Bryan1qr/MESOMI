...
labels <- c(
  ...
  "UNANUE PDF", "DM HOTELES PDF",  "VIGIL PDF", "ODRÍA PDF"
)
...
reactable(
  data,
  columns = list(
    Documento = colDef(html = TRUE)  # Importante: permite HTML sin escaparlo
  ),
  bordered = TRUE,
  highlight = TRUE,
  striped = TRUE,
