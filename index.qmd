...
plot_ly(df$df, x = ~date, y = ~pm10,
  ...
  # Etiquetas de OMS y ECA como labels
  add_trace(x = median(df$df$date, na.rm = TRUE),
            y = 100, type = "scatter", mode = "text",
            text = "ECA", textposition = "top right", 
            textfont = list(color = "red",
                            size = 12, family = "Arial", weight = "bold"),
            showlegend = FALSE) %>%
  
  add_trace(x = median(df$df$date, na.rm = TRUE),
            y = 45, type = "scatter", mode = "text",
            text = "OMS", textposition = "top right", 
            textfont = list(color = "red",
                            size = 12, family = "Arial", weight = "bold"),
            showlegend = FALSE) %>%
  
  # Etiquetas y tema
  layout(yaxis = list(title = "PM10"),
    showlegend = FALSE,
    margin = list(t = 50),
