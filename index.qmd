...
data %>%
  ...
  cols_label(
    ...
    Botón = "Documento") %>%
  fmt_url(
    columns = 4, as_button = FALSE,label = c(
      "EMCA-01 PDF", "EMCA-02 PDF","EMCA-03 PDF",
      "EMCA-04 PDF","EMCA-05 PDF", "EMCA-06 PDF",
      "UNANUE PDF", "DM HOTELES PDF",  "VIGIL PDF", "ODRÍA PDF")) %>%
  tab_caption(caption = "La Siguiente tabla contiene los reportes correspondientes a cada punto de monitoreo evaluado en los años 2024 y 2025.") %>%
  tab_style(
    style = list(
