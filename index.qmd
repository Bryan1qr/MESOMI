...
g1 <- df$eca %>% 
  ...
  geom_hline(yintercept = 100, lty = 2, color = "darkgreen") +
  geom_hline(yintercept = 45, lty = 2, color = "darkblue") +
...
g2 <- df$df %>% 
  ...
  geom_text(aes(x = median(df$df$date, na.rm = T),
                   y = 94,label = "ECA", color = "black")) +
  geom_text(aes(x = median(df$df$date, na.rm = T),
                   y = 50,label = "OMS", color = "black")) +
  labs(x = "", y = "PM10")+
...
g3 <- df$eca %>% 
  ...
  geom_hline(yintercept = 50, lty = 2, color = "darkgreen") +
