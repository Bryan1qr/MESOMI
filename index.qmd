...
```{r}
#| title: "REPORTES DE MONITOREO DE CALIDAD DE AIRE"
library(gt)
...
data %>%
  ...
  tab_caption(caption = "La Siguiente tabla contiene los reportes correspondientes a cada punto de monitoreo evaluado en el año 2024, puedes visualizar cada reporte haciendo clic en el botón azul para abrir el PDF.") %>% 
  tab_style(
    style = list(
...
windroseMap(data = dfm,
  ...
  addMarkers(lat = -18.004275,
            lng = -70.257304,
            popup = paste(sep = "<br/>",
            "<center><b>EMCA - 01</b>",
            "Ex sede Hipólitu Unanue",
            "Latitud:-18.004275", "Longitud: -70.257304",
            "Calidad de aire: <b><font style='color:rgb(255,201,5)'>MODERADA</font></b>")) %>% 
  addMarkers(lat = -17.993250,
            lng = -70.243305,
            popup = paste(sep = "<br/>",
            "<center><b>EMCA - 02</b>",
            "IESP Francisco de Paula Gonzáles Vigil",
            "Latitud: -17.993250", "Longitud: -70.243305",
            "Calidad de aire: <b><font style='color:rgb(255,201,5)'>MODERADA</font></b>")) %>% 
  addMeasure(primaryLengthUnit = "meters",
             primaryAreaUnit = "sqmeters") %>%  
  addSearchOSM() %>% 
