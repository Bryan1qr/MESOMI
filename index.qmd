...
dfm <- rbind(dfm, dfm1, dfm2, dfm3, dfm4, dfm5, df20251, df20252, df20253)
...
placexd <- data.frame(AQI = c(
  ...
  estación = c("DM HOTELES", "VIGIL"),
  lat = c(-18.01429, -17.99325),
  lon = c(-70.24903, -70.24331),
  lugar = c("DM Hoteles",
...
data <- data.frame(
  ...
  Botón = c("INFORMES TERMINADOS/EMCA-01_o.pdf", "INFORMES TERMINADOS/EMCA-02_o.pdf",
            ...
            "INFORMES TERMINADOS/VIGIL2025.pdf")
)
...
data %>%
  ...
  fmt_url(
    columns = 4, as_button = FALSE,label = c(
      ...
      "UNANUE PDF", "DM HOTELES PDF",  "VIGIL PDF")) %>%
