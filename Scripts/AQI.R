aqi_index <- function(df){
  ...
  aqi_tabla <- tibble(category = c(
    ...
    max_no2 = c(53, 100, 360, 649, 1249, Inf),
    min_so2 = c(0, 36, 76, 186, 305, 605),
    max_so2 = c(35, 75, 185, 304, 604, Inf),
    min_co = c(0, 4.5, 9.5, 12.5, 15.5, 30.5),
    max_co = c(4.4, 9.4, 12.4, 15.4, 30.4, Inf),
